      ...
      <div style={{
        ...
        <div style={{
          ...
          {getVisibleTestimonials().map((testimonial, index) => {
            ...
            // On mobile: displayed card is non-active (blue). On desktop: center card is active (white)
            ...
            >
              ...
              <p style={{
                ...
                {new Date(testimonial.created_at).toLocaleDateString(isRTL ? 'ar-SA' : 'en-US')}
              </p>
            </div>
          );
          })}
